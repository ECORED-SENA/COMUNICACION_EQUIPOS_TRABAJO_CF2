  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conflictos en la comunicación y sus soluciones
        p.mb-4 Se presentan una serie de opciones entre las que se deberá elegir la correcta, correspondiente a las estrategias de la resolución de conflictos. 
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Canales de comunicación
        p.mb-4 Identificar la palabra que corresponde en el espacio relacionado con los canales de comunicación más conocidos en las organizaciones.
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
